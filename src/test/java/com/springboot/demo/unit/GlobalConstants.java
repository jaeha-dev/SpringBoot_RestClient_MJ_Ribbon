...
public class GlobalConstants {
    ...
    public static final String USER_URI = "http://52.78.148.181:8080/user-service";
    public static final String BOARD_URI = "http://52.78.148.181:8080/board-service";
    public static final String RESTAURANT_URI = "http://52.78.148.181:8080/restaurant-service";
